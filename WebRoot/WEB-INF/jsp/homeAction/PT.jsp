...
<html>
  ...
  <body class="easyui-layout">
    ...
    <div data-options="region:'north',border:false" style="height:100px; padding:5px; background:#B0E0E6"> 
        ...
        <span class="loginInfo" style="font-size:15px;font-weight:bold;">登录用户：<a href="javascript:checkPersonInfor()">${user.loginName }</a>&nbsp;&nbsp;姓名：${user.userName }&nbsp;&nbsp;角色：普通用户&nbsp;&nbsp;&nbsp;&nbsp;</span>
	...
	<div data-options="region:'west',split:true,title:'导航菜单'" style="width:200px;"> 
        <div id="divTree" class="easyui-accordion" fit="true" border="false">
        	 ...
        	 <div data-options="iconCls:'icon-health'" title="我的健康">
